...
function init( event )
{
	...
	cssRenderer.setSize( player.dom.offsetWidth, player.dom.offsetHeight )
	player.dom.append( cssRenderer.domElement )
}

function update( event )
{
	if( cssRenderer.domElement.offsetHeight != player.dom.offsetHeight )
		cssRenderer.setSize( player.dom.offsetWidth, player.dom.offsetHeight )
